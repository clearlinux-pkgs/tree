...
Version  : 2.1.3
Release  : 22
URL      : https://oldmanprogrammer.net/tar/tree/tree-2.1.3.tgz
Source0  : https://oldmanprogrammer.net/tar/tree/tree-2.1.3.tgz
...
%prep
%setup -q -n tree-2.1.3
cd %{_builddir}/tree-2.1.3
pushd ..
cp -a tree-2.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720654824
