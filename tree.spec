...
Source0  : https://oldmanprogrammer.net/tar/tree/tree-2.1.2.tgz
...
%prep
%setup -q -n tree-2.1.2
cd %{_builddir}/tree-2.1.2
pushd ..
cp -a tree-2.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720020649
