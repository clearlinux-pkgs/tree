...
Version  : 2.0.4
Release  : 14
URL      : https://mama.indstate.edu/users/ice/tree/src/tree-2.0.4.tgz
Source0  : https://mama.indstate.edu/users/ice/tree/src/tree-2.0.4.tgz
...
%prep
%setup -q -n tree-2.0.4
cd %{_builddir}/tree-2.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662499524
