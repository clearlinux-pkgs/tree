...
Source0  : http://mama.indstate.edu/users/ice/tree/src/tree-2.0.2.tgz
...
%prep
%setup -q -n tree-2.0.2
cd %{_builddir}/tree-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645057015
...
cp %{_builddir}/tree-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/tree/0b184ad51ba2a79e85d2288d5fcf8a1ea0481ea4
